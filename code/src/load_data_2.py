...
def load_data(interval,p):
    file_list1 = os.listdir('../data/day1')
    file_list2 = os.listdir('../data/day2')
    ...
    for file_name in file_list1:
        df1 = create_data(df1, file_name, root_dir='../data/day1', date='2020/02/14 ')

    # data create
    df2 = pd.DataFrame()
    df2['date'] = pd.date_range(start='2/18/2020 07:40:00', end='2/18/2020 08:30:59', freq='s')
    for file_name in file_list2:
        df2 = create_data(df2, file_name,root_dir='../data/day2',date='2020/02/18 ')
